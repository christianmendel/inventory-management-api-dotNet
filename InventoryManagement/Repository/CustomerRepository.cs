...
namespace InventoryManagement.Repository
{
    public class CustomerRepository : RepositoryBase, ICustomerRepository
    {
        ...
        public async Task<Customer> AddAsync(Customer customer)
        {
            ...
            var id = await _dbConnection.ExecuteScalarAsync<int>(query, customer, _dbTransaction);
            customer.AddId(id);
            return customer;
        }
        ...
        public async Task UpdateAsync(Customer customer)
        {
            ...
            await _dbConnection.ExecuteAsync(query, customer, _dbTransaction);
        }
        ...
        public async Task<Customer> GetByIdAsync(int id)
        {
            ...
            return await _dbConnection.QueryFirstOrDefaultAsync<Customer>(query, new { Id = id }, _dbTransaction);
        }

        public async Task<IEnumerable<Customer>> GetAllAsync()
        {
            var query = "SELECT * FROM customers";
            return await _dbConnection.QueryAsync<Customer>(query, _dbTransaction);
        }
    }
}
