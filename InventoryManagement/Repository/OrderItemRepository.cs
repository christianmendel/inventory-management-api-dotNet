...
namespace InventoryManagement.Repository
{
    public class OrderItemRepository : RepositoryBase, IOrderItemRepository
    {
        ...
        public async Task<OrderItem> AddAsync(OrderItem orderItem)
        {
            ...
            var id = await _dbConnection.ExecuteScalarAsync<int>(query, orderItem, _dbTransaction);
            orderItem.AddId(id);
            return orderItem;
        }
        ...
        public async Task UpdateAsync(OrderItem orderItem)
        {
            ...
            await _dbConnection.ExecuteAsync(query, orderItem, _dbTransaction);
        }
        ...
        public async Task<OrderItem> GetByIdAsync(int id)
        {
            ...
            return await _dbConnection.QueryFirstOrDefaultAsync<OrderItem>(query, new { Id = id }, _dbTransaction);
        }
        ...
        public async Task<IEnumerable<OrderItem>> GetAllByOrderIdAsync(int orderId)
        {
            ...
            return await _dbConnection.QueryAsync<OrderItem>(query, new { OrderId = orderId }, _dbTransaction);
        }
    }
}
