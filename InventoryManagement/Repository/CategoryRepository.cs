...
namespace InventoryManagement.Repository
{
    public class CategoryRepository : RepositoryBase, ICategoryRepository
    {
        ...
        public async Task<Category> AddAsync(Category category)
        {
            ...
            var id = await _dbConnection.ExecuteScalarAsync<int>(query, category, _dbTransaction);
            category.AddId(id);
            return category;
        }
        ...
        public async Task UpdateAsync(Category category)
        {
            ...
            await _dbConnection.ExecuteAsync(query, category, _dbTransaction);
        }
        ...
        public async Task<Category> GetByIdAsync(int id)
        {
            ...
            return await _dbConnection.QueryFirstOrDefaultAsync<Category>(query, new { Id = id }, _dbTransaction);
        }

        public async Task<IEnumerable<Category>> GetAllAsync()
        {
            var query = "SELECT * FROM categories";
            return await _dbConnection.QueryAsync<Category>(query, _dbTransaction);
        }
    }
}
