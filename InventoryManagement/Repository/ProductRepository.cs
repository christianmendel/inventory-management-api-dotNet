...
namespace InventoryManagement.Repository
{
    public class ProductRepository : RepositoryBase, IProductRepository
    {
        ...
        public async Task<Product> AddAsync(Product product)
        {
            ...
            var id = await _dbConnection.ExecuteScalarAsync<int>(query, product, _dbTransaction);
            product.AddId(id);
            return product;
        }
        ...
        public async Task UpdateAsync(Product product)
        {
            ...
            await _dbConnection.ExecuteAsync(query, product, _dbTransaction);
        }
        ...
        public async Task<Product> GetByIdAsync(int id)
        {
            ...
            return await _dbConnection.QueryFirstOrDefaultAsync<Product>(query, new { Id = id }, _dbTransaction);
        }

        public async Task<IEnumerable<Product>> GetAllAsync()
        {
            var query = "SELECT * FROM products";
            return await _dbConnection.QueryAsync<Product>(query, _dbTransaction);
        }
    }
}
